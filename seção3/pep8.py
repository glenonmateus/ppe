...
A ideai da PEP8 é que possamos escrever códigos Python de forma Pythônica
...
[3] - Utilize 4 espaçoes para identação! (Não use tab);

if 'a' in 'banana':
    print('tem')

[4] - Linhas em branco;
- Separar funções e definições de classe comduas linhas em branco;
