...
# OBS: o zip() utiliza como parâmetro o menor tamanho em iterável. Isso
# significa que se estiver trabalhando com iteráveis de tamanho diferentes,
# irá parar quando os elementos do menor
lista3 = [7, 8, 9, 10, 11]
