...
# Tuplas por exemplo são bastantes interessantes de serem utilizdas como chaves
...
# 2 - Poderíamos utilizar um tupla para isso
produto1 = ('Playstation 4', 1, 2300.00)
produto2 = ('God of War 4', 1, 150.00)
...
produto1 = {'nome': 'God of War 4', 'quantidade': 1, 'preco': 150.00}
carrinho.append(produto1)
carrinho.append(produto2)
print(carrinho)
