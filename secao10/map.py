...
# OBS: Após utilizar a função map() depois da primeira utilização do
# resultado, ele zera.
...
# Temos uma função:
# Função: f(x)
# Utilizamos a função map(f, dados) onde map irá 'mapear' cada elemento dos
# dados e aplicar a função.
