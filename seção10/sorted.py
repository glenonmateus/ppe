...
OBS: Não confunda, apesar do nome, com a função sort() que já estudamos em
Listas. O sort() só funciona em listas.
...
numeros = (6, 1, 8, 2)
print(numeros)
print(sorted(numeros))  # Ordernar do menos para o maior
print(numeros)
