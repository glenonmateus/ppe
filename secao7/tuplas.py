...
Existem basicamente duas diferenças:
    ...
    2 - As tuplas são imutáveis: Isso significa que ao ser criar um tupla ela
    não muda. Toda operação em um tupla gera uma nova tupla.
...
# CONCLUSÃO: Podemos concluir que tuplas são definidas pela
# vírgula e não pelo uso do parênteses

(4) -> Não é tupla
(4, ) -> É tupla
4, -> É tupla

# Podemos gerar um tupla dinamicamente com range(inicio, fim, passo)
...
# dado o fato das tuplas serem imutáveis
...
print(tupla1)
print(tupla2)
tupla1 = tupla1 + tupla2  # Tuplas são imutáveis, mas podemos sobrescrever
# seus valores
print(tupla1)
...
print(meses.index('Junho'))  # caso tenha mais de um elemento,
# ele retornará o indice do primeiro elemento
