...
Em linguagens de programação como o Java, ao declararmos atributos privados na
classes, costumamos a criar métodos públicos para manipulação desses atributos.
Esse métodos são conhecidos por getters e setters, onde os getters retornam o
valor do atributo e setters alteram os valores dos mesmos.
