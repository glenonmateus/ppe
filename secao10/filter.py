...
# OBS: Assim como na função map(), após serem utilizados os dados
# de filter() eles são excluídos da memória
...
# filter() -> Recebe dois parâmetros, uma função e um iterável e retorna
# um objeto filtrando apenas os elementos de acordo com a função
...
# Forma 1
# inativos = list(filter(lambda usuario: len(usuario['tweets']) == 0,
                         usuarios))
...
# Devemos criar uma lista contendo 'Sua instrutura é' + nome, desde que cada
