...
OBS: Funções Python que retornam valores, devem retornar estes
valores com a palavra reservada return

OBS: Não precisamos necessariamente criar uma variável para receber
o retorno de uma função. Podemos passar a execuçao da função para
outras funções.
...
3 - Podemos, em uma função, retornar qualquer tipo de dado e até mesmo
múltiplos valores;
...
# Exemplo 3 - Podemos, em uma função, retornar qualquer tipo de dado e até
...
# Erros comuns na utilização do retorno, mas que na verdade nem é erro,
# mas sim codificação desnecessária.
