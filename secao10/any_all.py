...
all() -> Retorna True se todos os elementos do iterável são verdadeiros ou
ainda se o iterável está vazio.
...
nomes = ['Carlos', 'Camila', 'Carla', 'Cassiana', 'Cristiana']
print(all([nome[0] == 'C' for nome in nomes]))

# OBS: Um iterável vazio convertido em boolean é False, mas o all() entende
# como True
...
nomes = ['Carlos', 'Camila', 'Carla', 'Cassiana', 'Cristiana', 'Vanessa']
